                ...
                <div class="card card-statistics h-100">
                    <div class="card-body">
                        <div class="accordion gray plus-icon round">
                            ...
                            @foreach ($stages_with_sections as $stage_with_sections)

                                <div class="acd-group">
                                    <a href="#" class="acd-heading">{{ $stage_with_sections->name }}</a>
                                    <div class="acd-des">
                                                        ...
                                                        <div class="table-responsive mt-15">
                                                            <table class="table center-aligned-table mb-0">
                                                                ...
                                                                <tr class="text-dark">
                                                                    ...
                                                                    <th>{{ trans('Sections_trans.Name_Stage') }}</th>
                                                                ...
                                                                <tbody>
                                                                    <?php $i = 0; ?>
                                                                @foreach ($stage_with_sections->sections as $list_Sections)
                                                                    <tr>
                                                                            <?php $i++; ?>
                                                                        <td>{{ $i }}</td>
                                                                        <td>{{ $list_Sections->name }}</td>
                                                                        <td>{{ $list_Sections->grade->name }}
                                                                        </td>
                                                                        <td>
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    ...
                                                                                    <form
                                                                                        ...
                                                                                        <div class="col">
                                                                                            <label for="inputName"
                                                                                                   class="control-label">{{ trans('Sections_trans.Name_Stage') }}</label>
                                                                                            <select name="Stage_id"
                                                                                                    class="custom-select"
                                                                                                    onclick="console.log($(this).val())">
                                                                                                <!--placeholder-->
                                                                                                <option
                                                                                                    value="{{ $stage_with_sections->id }}">
                                                                                                    {{ $stage_with_sections->name }}
                                                                                                </option>
